...
void ADp(int *n, double *z, double *pval) {
    *pval=AD(*n,*z);
}
...
void ADtest(int *nptr, double *x, double *pval, double *stat)
{ 
    int i;
    int n=*nptr;
    double t,z=0;
...
/*  scanf("%d %lf",&n,&z); */
/*  x=adinf(z); */
/*  printf("             adinf(z)=x=%9.5f\n",x); */
/*  printf("            errfix(n,x)=%9.5f\n",errfix(n,x)); */
/*  printf("   Prob(A_%2d < %7.4f)=%9.5f\n",n,z,AD(n,z)); */
/* 	 } */
